...
class DataInspector:
    ...
    def _analyze_sample_structure(self, sample: Any) -> Dict[str, Any]:
        ...
        """
        structure: Dict[str, Any] = {"type": type(sample).__name__, "fields": {}}
            ...
            if isinstance(samples[0], dict):
                ...
                if "labels" in keys or "label" in keys:
                    ...
                    if all(
                        ...
                        or (isinstance(lbl, torch.Tensor) and lbl.numel() == 1)
                        for lbl in labels
                    ):
                        unique_labels = set()
                        for lbl in labels:
    ...
    def _recommend_batch_size(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if data_type == "vision":
                recommendations["optimal_batch_size"] = min(
                    recommendations["optimal_batch_size"], 16
                )
    ...
    def _suggest_preprocessing(self) -> Dict[str, List[str]]:
        ...
        """
        suggestions: Dict[str, List[str]] = {"required": [], "recommended": [], "optional": []}
    ...
    def generate_report(self) -> str:
        ...
        lines = ["=" * 70, "DATA INSPECTION REPORT", "=" * 70, ""]
        ...
        if "preprocessing" in report:
            ...
            lines.extend(["PREPROCESSING RECOMMENDATIONS", "-" * 70])
