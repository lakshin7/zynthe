...
class ResourceProbe:
    ...
    def _probe_devices(self) -> Dict[str, Any]:
        ...
        if hasattr(torch.backends, "mps") and torch.backends.mps.is_available():
            ...
            devices["mps"] = {"available": True, "is_built": torch.backends.mps.is_built()}
    ...
    def _probe_memory(self) -> Dict[str, Any]:
        ...
        Returns:
            Memory information
        """
        memory: Dict[str, Any] = {"system": {}, "gpu": []}
    ...
    def _probe_compute_capability(self) -> Dict[str, Any]:
        ...
        if torch.cuda.is_available() and torch.cuda.device_count() > 1:
            try:
                ...
                logger.debug("NCCL / distributed probe failed")
    ...
    def estimate_memory_usage(
        ...
        if sequence_length:
            ...
            activation_memory = (batch_size * sequence_length * 768 * 12 * 4 * param_bytes) / (
                1024**3
            )
        else:
    ...
    def recommend_optimal_batch_size(
        ...
        while low <= high:
            mid = (low + high) // 2
            usage = self.estimate_memory_usage(model_params, mid, sequence_length, precision)
    ...
    def generate_report(self) -> str:
        ...
        lines = ["=" * 70, "RESOURCE PROBE REPORT", "=" * 70, ""]
        ...
        # CPU info
        cpu = devices["cpu"]
        lines.extend([f"CPU Cores: {cpu['count']} physical, {cpu['logical_count']} logical", ""])
