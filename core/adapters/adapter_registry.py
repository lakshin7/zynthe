...
class AdapterRegistry:
    ...
    def detect(self, model: nn.Module) -> ModelAdapter:
        ...
        Walks the detection order (VLM → Multimodal → Vision → Text)
